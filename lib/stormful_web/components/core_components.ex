  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        value={Phoenix.HTML.Form.normalize_value(@type, @value)}
        class={[
          "mt-2 block w-full rounded-lg text-white placeholder:text-yellow-200 focus:ring-0 sm:text-sm sm:leading-6 bg-transparent",
          "phx-no-feedback:border-yellow-300 phx-no-feedback:focus:border-yellow-400",
          @errors == [] && "border-yellow-300 focus:border-yellow-400",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
      />
